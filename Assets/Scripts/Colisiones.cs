...
public class Colisiones : MonoBehaviour
{
    ...
    {
        if (other.gameObject.name == "BossDoor") //Si el otro gameobject con el que colisiona es la puerta de salida...
        {
        ...
        if (other.gameObject.name == "MemoramaDoor") //Si el otro gameobject con el que colisiona es la puerta de salida...
        {
